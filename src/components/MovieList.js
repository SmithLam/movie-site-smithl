          ...
          <div className="col-md-12 d-flex flex-wrap justify-content-center">
            ...
            (item => 
                {return(
                  ...
                  <Card.ImgOverlay>
                  <div id="card-content">
                  <Card.Title className="mb-3"><a id="item-title" href={`https://www.themoviedb.org/movie/${item.id}?language=en-US`}>{item.title}</a></Card.Title>
                  <Card.Text className="mb-2">{item.genre_ids.map(movieId => {
                  ...
                  <Card.Text><Button variant="outline-success" onClick={()=>props.searchYoutube(item.id)}>View Trailer</Button></Card.Text>
                  <Card.Text>
