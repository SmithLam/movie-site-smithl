    ...
    return (
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="mr-auto">
            ...
            <NavDropdown className="d-flex flex-row-reverse" title="Trending" id="collasible-nav-dropdown">
              <NavDropdown.Item onClick={()=> props.getTrendMovie("now_playing")}>Currently Showing</NavDropdown.Item>
              <NavDropdown.Item onClick={()=> props.getTrendMovie("upcoming")}>Upcoming</NavDropdown.Item>
              <NavDropdown.Item onClick={()=> props.getTrendMovie("top_rated")}>Top Rated</NavDropdown.Item>
              </NavDropdown>
